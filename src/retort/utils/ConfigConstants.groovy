...
class ConfigConstants {
  ...
  public static final ANSI_COLOR_LOG_FILTER = "hudson.plugins.ansicolor.AnsiColorConsoleLogFilter"
  public static final MERGED_LOG_FILTER = "org.jenkinsci.plugins.workflow.steps.BodyInvoker.MergedFilter"
